        ...
        <svg
            ...
            <defs>
                ...
                <filter
                    ...
                    <feFlood flood-opacity=".62" />
                    <feComposite operator="in" in2="blur" />
                    <feComposite in="SourceGraphic" />
                </filter>
            </defs>
            <g data-name="Web 1920 – 2" clip-path="url(#a)">
                <path fill="#fff" d="M0 0h1920v1080H0z" />
                <g class="bottom" data-name="Path 5" fill="#cd6684">
                ...
                <path
                    ...
                    fill="#ff677d"
                />
                <g class="bubble" id="Group_1" data-name="Group 1">
                    <circle
                        id="Ellipse_1"
                        data-name="Ellipse 1"
                        cx="69"
                        cy="69"
                        r="69"
                        transform="translate(167 38)"
                        fill="#df4773"
                    />
                </g>
                />
                <g class="text" filter="url(#b)">
                    <text
                        data-name="My name is Joel Coddington. I'm a student web developer."
                        transform="translate(1008 502.39)"
                        fill="#fff"
                        font-size="67"
            ...
            <g class="bubble-two" id="Group_1" data-name="Group 1">
                <circle
                    id="Ellipse_1"
                    data-name="Ellipse 1"
                    cx="69"
