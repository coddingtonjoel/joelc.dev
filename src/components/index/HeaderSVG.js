                    ...
                    <g
                        ...
                        <g
                            ...
                            <g id="Icons" transform="translate(254.38 89.603)">
                                ...
                                <g
                                    id="Sketch"
                                    transform="translate(-2.5 102) scale(0.75)">
                                    <g id="sketch-symbol" ref={addToIcons}>
                                        <path
                                            id="Path"
                                            d="M21.29,2.907,48.79,0l27.5,2.907,21.29,28.58L48.79,88.3,0,31.487Z"
                                            fill="#fdb300"
                                        />
                                        <g
                                            id="Group"
                                            transform="translate(0 31.487)">
                                            <path
                                                id="Path-2"
                                                data-name="Path"
                                                d="M19.762,0,48.79,56.815,0,0Z"
                                                fill="#646464"
                                            />
                                            <path
                                                id="Path-3"
                                                data-name="Path"
                                                d="M19.762,56.815,48.79,0,0,56.815Z"
                                                transform="translate(97.579 56.815) rotate(180)"
                                                fill="#646464"
                                            />
                                            <path
                                                id="Path-4"
                                                data-name="Path"
                                                d="M79.634,0h58.055L108.661,56.815Z"
                                                transform="translate(-59.872)"
                                                fill="#8b8b8b"
                                            />
                                        </g>
                                        <g id="Group-2" data-name="Group">
                                            <path
                                                id="Path-5"
                                                data-name="Path"
                                                d="M108.661,0l-27.5,2.907-1.528,28.58Z"
                                                transform="translate(-59.872)"
                                                fill="#adadad"
                                            />
                                            <path
                                                id="Path-6"
                                                data-name="Path"
                                                d="M29.027,31.487,1.528,28.58,0,0Z"
                                                transform="translate(77.817 31.487) rotate(180)"
                                                fill="#adadad"
                                            />
                                            <path
                                                id="Path-7"
                                                data-name="Path"
                                                d="M0,0,21.29,28.58,19.762,0Z"
                                                transform="translate(97.579 31.487) rotate(180)"
                                                fill="#8b8b8b"
                                            />
                                            <path
                                                id="Path-8"
                                                data-name="Path"
                                                d="M0,40.295l21.29-28.58-1.528,28.58Z"
                                            ...
                                            <path
                                                id="Path-9"
                                                data-name="Path"
                                                d="M108.661,0,79.634,31.487h58.055Z"
                                                transform="translate(-59.872)"
                                                fill="#c1c1c1"
                                            />
                                        </g>
                                ...
                                <g
                                    id="Nextjs"
                                    transform="translate(110.494 98) scale(0.675)">
                                    <g
                                        id="Next.js"
                                        ref={addToIcons}
                                        ...
                                        <g
                                            id="Group_7"
                                            className="nextjs-inside"
                                            data-name="Group 7"
                                            transform="translate(14.7 30.61)">
                                            <path
                                                id="Path_29"
                                                className="nextjs-inside"
                                                data-name="Path 29"
                                                d="M87.245,13.294h15.384v1.218H88.655v9.166H101.8V24.9H88.655V34.958h14.134v1.218H87.245Zm16.762,0h1.635l7.243,10.063,7.4-10.063L130.358.512l-16.544,23.9,8.525,11.762h-1.7l-7.756-10.7-7.788,10.7H103.43l8.589-11.762Zm18.941,1.218V13.294H140.48v1.218H132.4V36.176h-1.41V14.512Z"
                                                transform="translate(-67.999 -0.512)"
                                            />
                                            <path
                                                className="nextjs-inside"
                                                id="Path_30"
                                                data-name="Path 30"
                                                d="M.362,58.215H2.125L26.432,94.442,16.387,81.1,1.836,59.946,1.772,81.1H.362Z"
                                                transform="translate(-0.362 -45.433)"
                                            />
                                            <path
                                                className="nextjs-inside"
                                                id="Path_31"
                                                data-name="Path 31"
                                                d="M325.505,136.034a.5.5,0,1,0-.505-.5A.492.492,0,0,0,325.505,136.034Zm1.388-1.32a1.372,1.372,0,0,0,1.512,1.381,1.407,1.407,0,0,0,1.532-1.539v-3.438h-.77v3.435c0,.542-.278.832-.77.832a.685.685,0,0,1-.749-.67Zm4.051-.044c.055.869.794,1.424,1.893,1.424,1.175,0,1.91-.583,1.91-1.512,0-.731-.419-1.135-1.436-1.367l-.546-.131c-.646-.148-.907-.347-.907-.694,0-.438.405-.724,1.013-.724a.944.944,0,0,1,1.048.727h.749A1.609,1.609,0,0,0,332.881,131c-1.082,0-1.8.576-1.8,1.441,0,.714.409,1.138,1.306,1.344l.639.152c.656.152.945.374.945.744,0,.431-.453.744-1.072.744-.663,0-1.123-.293-1.189-.754Z"
                                                transform="translate(-253.088 -102.095)"
                                            />
                                        </g>
                                    </g>
                                </g>
